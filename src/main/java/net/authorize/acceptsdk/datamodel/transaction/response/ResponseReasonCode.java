...
public enum ResponseReasonCode {
  ...
  SDK_RESPONSE_REASON_CODE_ONE_OR_MORE_FIELDS_MISSING(101,
      "The request is missing one or more required fields", "DECLINED"),
  SDK_RESPONSE_REASON_CODE_ONE_OR_MORE_FIELDS_INVALID(102,
      "One or more fields in the request contains invalid data.", "DECLINED"),
  ...
  SDK_RESPONSE_REASON_CODE_APPROVED_BUT_DECLINED_BECAUSE_AVS(200,
      "The authorization request was approved by the issuing bank "
          + "but declined by CyberSource because it did not pass the Address Verification System (AVS) check.",
      "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_QUESTIONS(201,
      "The issuing bank has questions about the request.", "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_EXPIRED_CARD(202, "Expired card.", "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_GENERAL_DECLINE(203, "General decline of the card.",
      "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_INSUFICCIENT_FUNDS(204, "Insufficient funds in the account.",
      "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_STOLEN_OR_LOST_CARD(205, "Stolen or lost card.", "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_ISSUING_BANK_UNAVAILABLE(207, "Issuing bank unavailable.",
      "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_INACTIVE_CARD(208,
      "Inactive card or card not authorized for card-not-present transactions.", "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_CVN_DID_NOT_MATCH(209, "CVN did not match.", "DECLINED"),
  SDK_RESPONSE_REASON_CODE_DECLINED_CARD_CREDIT_LIMIT_REACHED(210,
      "The card has reached the credit limit.", "DECLINED"),
   ...
   *
   * @return properly mapped reason code; if mapping was unsuccessful returns
   * ResponseReasonCode.SDK_RESPONSE_REASON_CODE_UNKNOWN with reason code 0
   */
