 ...
 * kbollepa@visa.com
 */
public class EncryptTransactionResponse implements Parcelable{
...
//        dest.writeString(encryptedPaymentData);
    ...
    public static final Parcelable.Creator<EncryptTransactionResponse> CREATOR = new Parcelable.Creator<EncryptTransactionResponse>() {

        @Override
        public EncryptTransactionResponse createFromParcel(Parcel in) {
            return new EncryptTransactionResponse(in);
        }

        @Override
        public EncryptTransactionResponse[] newArray(int size) {
