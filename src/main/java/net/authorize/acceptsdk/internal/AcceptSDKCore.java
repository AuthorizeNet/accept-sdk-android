...
public class AcceptSDKCore implements TransactionResultReceiver.Receiver{
    ...
    public boolean performEncryption(EncryptTransactionObject transactionObject, EncryptTransactionCallback callback ) {
        ...
        AcceptService.startActionEncrypt(AcceptSDKApiClient.getContext().get(),transactionObject,mResultReceiver);
        return sTransactionInProgress;
    }
    ...
    public void onReceiveResult(int resultCode, Bundle resultData) {
        ...
        switch (resultCode){
            case AcceptService.SERVICE_RESULT_CODE_SDK_RESPONSE :
               EncryptTransactionResponse response = (EncryptTransactionResponse)
